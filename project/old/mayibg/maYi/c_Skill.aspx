<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_Skill.aspx.cs" Inherits="c_Skill" %>
		...
		<div class="body_wap">
			...
			<div class="resume-cont">
				...
				<div class="add_resume_tjbth">
					<a class="add_resume_tj" href="<%=Uwexperience%>">+ 添加职业技能</a>
