        ...
        <div class="navbar-container" id="navbar-container">
            ...
            <div class="navbar-header pull-right" role="navigation">
                <ul class="nav ace-nav">
                    ...
                    <li class="purple">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-bell-alt"></i><%=badge %></a>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <div id="menu_style" class="menu_style">
                    <ul class="nav nav-list" id="nav_list">
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text">职位管理 </span><b class="arrow icon-angle-down"></b></a>
                            <ul class="submenu">
                                <li class="home"><a href="javascript:void(0)" name="qy_job.aspx" title="全职管理" class="iframeurl"><i class="icon-double-angle-right"></i>全职管理<%=joblent %></a></li>
                                <li class="home"><a href="javascript:void(0)" name="qy_part.aspx" title="兼职管理" class="iframeurl"><i class="icon-double-angle-right"></i>兼职管理<%=jobpart %></a></li>
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text">企业管理 </span><b class="arrow icon-angle-down"></b></a>
                            <ul class="submenu">
                                <li class="home"><a href="javascript:void(0)" name="qy_info.aspx" title="企业管理" class="iframeurl"><i class="icon-double-angle-right"></i>企业管理<%=jobinfo %></a></li>
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle"><i class="icon-credit-card"></i><span class="menu-text">简历管理 </span><b class="arrow icon-angle-down"></b></a>
                            <ul class="submenu">
                                <li class="home"><a href="javascript:void(0)" name="m_info.aspx" title="个人信息" class="iframeurl"><i class="icon-double-angle-right"></i>个人信息</a></li>
                                <li class="home"><a href="javascript:void(0)" name="m_resume.aspx" title="简历管理" class="iframeurl"><i class="icon-double-angle-right"></i>简历管理</a></li>
<%--                            <li class="home"><a href="javascript:void(0)" name="Wexperience.aspx" title="工作经历" class="iframeurl"><i class="icon-double-angle-right"></i>工作经历</a></li>
                                <li class="home"><a href="javascript:void(0)" name="educationA.aspx" title="教育经历" class="iframeurl"><i class="icon-double-angle-right"></i>教育经历</a></li>
                                <li class="home"><a href="javascript:void(0)" name="project.aspx" title="项目经历" class="iframeurl"><i class="icon-double-angle-right"></i>项目经历</a></li>
                                <li class="home"><a href="javascript:void(0)" name="Train.aspx" title="培训经历" class="iframeurl"><i class="icon-double-angle-right"></i>培训经历</a></li>
                                <li class="home"><a href="javascript:void(0)" name="functionA.aspx" title="职业技能" class="iframeurl"><i class="icon-double-angle-right"></i>职业技能</a></li>
                                <li class="home"><a href="javascript:void(0)" name="evaluate.aspx" title="自我评价" class="iframeurl"><i class="icon-double-angle-right"></i>自我评价</a></li>
                                <li class="home"><a href="javascript:void(0)" name="wcase.aspx" title="作品案例" class="iframeurl"><i class="icon-double-angle-right"></i>作品案例</a></li>--%>
                            </ul>
                        </li>
                        <li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text">资讯管理 </span><b class="arrow icon-angle-down"></b></a>
                            <ul class="submenu">
                                <li class="home"><a href="javascript:void(0)" name="picture.aspx" title="职场资讯" class="iframeurl"><i class="icon-double-angle-right"></i>职场资讯</a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li class="home"><a href="javascript:void(0)" name="user_list.aspx" title="会员列表" class="iframeurl"><i class="icon-double-angle-right"></i>会员列表</a></li>
