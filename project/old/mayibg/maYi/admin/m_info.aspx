<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_info.aspx.cs" Inherits="admin_m_info" %>
                ...
                <div class="d_Confirm_Order_style">
                    <div class="search_style">
                        ...
                        <ul class="search_content clearfix">
                            <li>
                                <label class="l_f">关键字</label><input runat="server" id="txtKeywords" name="txtKeywords" type="text" class="text_add" placeholder="姓名" style="width: 400px" /></li>
                    ...
                    <div class="border clearfix">
                        <span class="l_f">
                            <a href="#" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加个人信息</a>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                      ...
                                      <%--  <asp:CheckBox ID="cdDelete" ToolTip='<%#Eval("Id") %>' Text="" runat="server"/>--%>
                                    </td>
                                    <td>
                                        <a href="m_info_add.aspx?Id=<%#Eval("Id") %>" style="cursor: pointer" class="text-primary"><%#Eval("name")%></a>
                                    </td>
                                    <td><%#Eval("sex")%></td>
                                    <td><%#Eval("birthday")%></td>
                                    <td><%#Eval("edu")%></td>
                                    ...
                                    <td><%#Eval("time")%></td>
                                    <td class="td-manage">
                                        <a title="个人信息详细" href="m_info_add.aspx?Id=<%#Eval("Id") %>" class="btn btn-xs btn-info Refund_detailed">详细</a>
                                        <a title="删除"  href="m_info.aspx?del=<%#Eval("Id") %>"  onclick="return confirm('确定删除?');" class="btn btn-xs btn-warning"><i class="icon-trash  bigger-120"></i></a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
