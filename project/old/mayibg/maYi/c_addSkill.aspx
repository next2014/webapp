<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_addSkill.aspx.cs" Inherits="c_addSkill" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function UserAddVerify() {
            ...
            else if (Longtime == "" || Longtime == null) {
                alert("请输入掌握时间");
                return false;
            }
                        ...
                        <div id="main" class="mui-page mui-page-center">
                            ...
                            <div class="mui-page-content">
                                <div class="mui-scroll-wrapper" data-scroll="2">
                                        ...
                                        <div class="resume-cont">
                                            <div class="">
                                                <ul class="yunset_list mt15">
													<li class="yunset_list_text"><span class="yunset_list_name">技能名称</span> <span class="yunset_list_commentary">
                                                        <input type="text"  runat="server" name="name" id="name" value="" placeholder="请输入技能名称" /></span></li>
													<li class="yunset_list_text"><span class="yunset_list_name">掌握时间</span> 
                                                        <span class="yunset_list_commentary" style="padding-right:20px;">
                                                            <input type="text"  runat="server" name="longtime" id="longtime" value="" placeholder="请输入掌握时间，单位“年”" /></span><i style=" position:absolute;right:10px;top:0px; display:inline-block; line-height:44px;">年</i></li>
												</ul>
									...
									<img id="previewimg" src="" runat="server" border="0" onerror="showImgDelay(this,'https://www.zhirimao.com/',2);" style="border-radius:0;" />
								</span>
														<div class="yunset_list_file"><input type="file" name="pic" onchange="previewImage(this,'preview')" accept="image/*" class=" " />
															<input type="hidden" runat="server" name="preview" value="" id="preview" /></div>
													</li>
												</ul>
