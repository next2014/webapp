<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_PartTime.aspx.cs" Inherits="m_PartTime" %>
...
<body class="mui-ios mui-ios-11 mui-ios-11-0">
    ...
    <ul class="yun_m_tit">
        <li class="yun_m_tit_cur"><a href="m_PartTime.aspx">兼职报名</a></li>
        <li><a href="m_PartTime_1.aspx">兼职收藏</a></li>
    </ul>
