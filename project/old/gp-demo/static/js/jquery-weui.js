  ...
  var Picker = function (params) {
      ...
      p.updateValue = function () {
          ...
          if (p.input && p.input.length > 0) {
        	  if(p.params.setUp){
                  if(p.params.setUp=="YYYY-MM"){  //自定义添加的属性
                      $(p.input).val(p.params.formatValue ? p.value.slice(0,1)+p.params.yearSplit+p.displayValue.slice(1,2) : p.value.join(''));
                  }else if(p.params.setUp=="YYYY"){//自定义添加的属性
                      $(p.input).val(p.params.formatValue ? p.value.slice(0,1): p.value.join(''));
                  }
         }else{
  ...
  defaults = $.fn.calendar.prototype.defaults = {
    ...
    monthPickerTemplate: 
        '<div class="picker-calendar-month-picker">' +
            '<a href="javascript:;" class="link icon-only picker-calendar-prev-month"><i class="fa fa-chevron-left"></i></a>' +
            '<div class="current-month-value"></div>' +
            '<a href="javascript:;" class="link icon-only picker-calendar-next-month"><i class="fa fa-chevron-right"></i></a>' +
        '</div>',
    yearPicker: true,
    yearPickerTemplate: 
        '<div class="picker-calendar-year-picker">' +
            '<a href="javascript:;" class="link icon-only picker-calendar-prev-year"><i class="fa fa-chevron-left"></i></a>' +
            '<span class="current-year-value"></span>' +
            '<a href="javascript:;" class="link icon-only picker-calendar-next-year"><i class="fa fa-chevron-right"></i></a>' +
        '</div>',
    weekHeader: true,
    // Common settings
    scrollToInput: true,
    ...
    getConfig: function() {
      ...
      var config = {
        ...
        cols: [
          ...
          {
        	   values: (function () { 
                   var monthes =''; //params.setUp自定义添加的属性
                    if(!params.setUp||params.setUp=="YYYY-MM"){
                        monthes =params.monthes;
                    }
                    return monthes;
                  })()
          },
          ...
          },
          {
        	  values: (function () { 
                  var dates = [];
                  if(!params.setUp){//params.setUp自定义添加的属性
