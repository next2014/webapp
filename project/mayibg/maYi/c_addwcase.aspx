<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_addwcase.aspx.cs" Inherits="c_addwcase" %>
                                        ...
                                        <div class="resume-cont">
                                            <div class="">
                                                <ul class="yunset_list mt15">
													<li class="yunset_list_text"><span class="yunset_list_name">作品标题</span> 
                                                        <span class="yunset_list_commentary">
                                                            <input type="text" runat="server" name="titlea" id="titlea" value="" placeholder="请输入作品标题" /></span></li>
													<li class="yunset_list_text"><span class="yunset_list_name">作品排序</span>
														<span class="yunset_list_commentary">
                                                            <input type="text" runat="server" name="sort" id="sort" value="" placeholder="请输入作品排序" /></span></li>
												</ul>
