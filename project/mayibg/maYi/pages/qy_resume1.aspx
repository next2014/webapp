<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_resume1.aspx.cs" Inherits="pages_qy_resume1" %>
...
<head>
    ...
    <title>蚂蚁帮工</title>
    <meta http-equiv="keywords" content=",蚂蚁帮工" />
    <meta http-equiv="description" content="蚂蚁帮工" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<body>
                            ...
                            <div class="header_bg  bg3">
                                ...
                                <div class="header_h1">
                                    <div class="header_fx_search">
                                        <a href="#searchhtml">
                                            <div class="formFiled">
                                                <input type="text" value="" name="keyword" class="input_search searchnew" placeholder="请输入简历关键字,如：服务员...">
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <ul class="searchOptions_list">
                               <%-- <li class="grade popup" data-pop="grade">
                                ...
                                <li class="Sortexp popup" data-pop="Sortexp">
                                    <a href="javascript:void(0);" class="searchOptions_list_a"><span class="job_ov">经验</span><i class="searchOptions_icon"></i></a>
                                </li>
    ...
    <div class="Sortexp-eject Sortexp-height">
        <ul class="Sortexp-Sortexp" id="Sortexp-Sortexp">
            <li>
                <a href="qy_resume.aspx?exp=无经验">无经验</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=应届毕业生">应届毕业生</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=1年以上">1年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=2年以上">2年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=3年以上">3年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=4年以上">4年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=5年以上">5年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=6年以上">6年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=8年以上">8年以上</a>
            </li>
            <li>
                <a href="qy_resume.aspx?exp=10年以上">10年以上</a>
            </li>
        </ul>
    </div>
    <!-- End Sortexp -->
                        ...
                        <div class="wap_search_header">
                            <form method="get" action="">
                                <div class="wap_search_text">
                                    <input type="text" value="" onkeyup="this.value = this.value.replace(/[,]/g,'');" id="input_search" name="keyword" class="" placeholder="请输入简历关键字，如：会计...">
                                </div>
            ...
            $.ready(function () {
                ...
                showCityPickerButton.addEventListener('tap', function (event) {
                    cityPicker3.show(function (items) {
                        location.href = "position.aspx?pro=" + _getParam(items[0], 'value') + "&city=" + _getParam(items[1], 'value') + "&three=" + _getParam(items[2], 'value');
                    });
                }, false);
                // 选择职能
