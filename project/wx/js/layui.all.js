...
! function() {
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		if(l.year < d[0] && (l.year = d[0], r.hint("鏈€浣庡彧鑳芥敮鎸佸埌鍏厓" + d[0] + "骞�")), l.year > d[1] && (l.year = d[1], r.hint("鏈€楂樺彧鑳芥敮鎸佸埌鍏厓" + d[1] + "骞�")), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y, function(e, n) {
...
layui.define("layer", function(e) {
	...
	p.prototype.config = {
		...
		switch(h = 0 === h.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "" : h, l.accept) {
			case "file":
				if(v && !RegExp("\\w\\.(" + v + ")$", "i").test(escape(h))) return o.msg("閫夋嫨鐨勬枃浠朵腑鍖呭惈涓嶆敮鎸佺殑鏍煎紡"), r.value = "";
				break;
			case "video":
				if(!RegExp("\\w\\.(" + (v || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(h))) return o.msg("閫夋嫨鐨勮棰戜腑鍖呭惈涓嶆敮鎸佺殑鏍煎紡"), r.value = "";
				break;
			case "audio":
				if(!RegExp("\\w\\.(" + (v || "mp3|wav|mid") + ")$", "i").test(escape(h))) return o.msg("閫夋嫨鐨勯煶棰戜腑鍖呭惈涓嶆敮鎸佺殑鏍煎紡"), r.value = "";
				break;
			default:
								...
								var C = function(e, t, a) {
									...
									w = function(e) {
										...
										return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (C(i, function(e) {
											e ? k.find("." + s)[0] || k.append('<p class="' + s + '">鏃犲尮閰嶉」</p>') : k.find("." + s).remove()
					...
					f.each(function(e, l) {
						...
						var v = "string" == typeof s.attr("lay-search"),
							...
							m = i(['<div class="layui-unselect ' + a + (o ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "" : "readonly") + ' class="layui-input layui-unselect' + (o ? " " + c : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ? " layui-select-group" : "") + '">' + function(e) {
								...
								}), 0 === i.length && i.push('<dd lay-value="" class="' + c + '">娌℃湁閫夐」</dd>'), i.join("")
							}(s.find("*")) + "</dl>", "</div>"].join(""));
				...
				radio: function() {
					...
					a.each(function(a, l) {
						var s = i(this),
							...
							u = this.disabled;
						if("string" == typeof s.attr("lay-ignore")) return s.show();
						var o = i(['<div class="layui-unselect ' + e + (l.checked ? " " + e + "ed" : "") + (u ? " layui-radio-disbaled " + c : "") + '">', '<i class="layui-anim layui-icon">' + t[l.checked ? 0 : 1] + "</i>", "<span>" + (l.title || "鏈懡鍚�") + "</span>", "</div>"].join(""));
	...
	H.prototype.config = {
		...
		if(n.url) {
			...
			c[o.pageName] = e, c[o.limitName] = n.limit, t.ajax({
				...
				dataType: "json",
				success: function(t) {
					return t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + h + '">' + (t[r.msgName] || "杩斿洖鐨勬暟鎹姸鎬佸紓甯�") + "</div>")) : (a.renderData(t, e, t[r.countName]), d(), i && l.close(i), void("function" == typeof n.done && n.done(t, e, t[r.countName])))
				},
				error: function(e, t) {
					a.layMain.html('<div class="' + h + '">鏁版嵁鎺ュ彛璇锋眰寮傚父</div>'), a.renderForm(), i && l.close(i)
				}
			})
		...
		return c.key = s.id || s.index, d.cache[c.key] = u, r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + h).remove(), c.layMain.append('<div class="' + h + '">鏃犳暟鎹�</div>')) : (m(), void(s.page && (c.page = n, c.count = o, a.render({
	...
	var o = layui.$,
		t = {
			...
			timeAgo: function(e, o) {
				...
				return t > 2592e6 ? (t = new Date(e).toLocaleString(), o && (t = t.replace(/\s[\S]+$/g, "")), t) : t >= 864e5 ? (t / 1e3 / 60 / 60 / 24 | 0) + "澶╁墠" : t >= 36e5 ? (t / 1e3 / 60 / 60 | 0) + "灏忔椂鍓�" : t >= 18e4 ? (t / 1e3 / 60 | 0) + "鍒嗛挓鍓�" : t < 0 ? "鏈潵" : "鍒氬垰"
			}
		};
	e("util", t)
});
