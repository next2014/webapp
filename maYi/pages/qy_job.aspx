<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_job.aspx.cs" Inherits="pages_qy_job" %>
...
<body class="mui-ios mui-ios-11 mui-ios-11-0" spellcheck="false">
    ...
    <div class="header_bg bg3">
        ...
        <div class="header_fa_add">
            <a href="qy_jobadd.aspx" class="header_fa_add_p">发布职位</a>
        </div>
        <!-- 发布兼职-->
    </div>
</header>
    <div class="mui-content pos_tab">
				<div class="mui-row">
					...
					<div class="mui-col-sm-6 mui-col-xs-6">
						<li class="mui-table-view-cell">
							<a href="qy_job.aspx" class="active" >
								全职管理
							</a>
						</li>
					</div>
