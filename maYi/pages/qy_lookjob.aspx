<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_lookjob.aspx.cs" Inherits="pages_qy_lookjob" %>
...
<body class="mui-ios mui-ios-11 mui-ios-11-0" spellcheck="false">
    ...
    <div class="header_bg bg3">
        ...
        <div class="header_h1">谁看过我</div>
    </div>
</header>
<section class="wap_member">
    <div class="wap_member_comp_h1"><span>被浏览的职位</span></div>
    <div class="wap_member_no">
        您暂时还没有人才浏览您的职位
        <div>
            <a class="wap_member_no_submit" href="../resume.aspx">去搜索人才</a>
        </div>
    </div>
</section>
