<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_collecRecord1.aspx.cs" Inherits="m_collecRecord1" %>
...
<body class="mui-ios mui-ios-11 mui-ios-11-0">
    ...
    <div class="body_wap">
        ...
        <div class="main_member_cot_box">
            <ul class="yun_m_tit">
                <li><a href="m_collecRecord.aspx">收藏的职位</a></li>
                <li class="yun_m_tit_cur"><a href="m_collecRecord1.aspx">关注的企业</a></li>
            </ul>
            <%=record%>

            <div class="wap_member_post_list" style="<%=display%>">
                    <div class="wap_member_no">
                        暂无关注的企业<div><a class="wap_member_no_search" href="c_company.aspx">去搜索我感兴趣的企业</a></div>
                    </div>
            </div>
            <div class="pages"></div>
        </div>
