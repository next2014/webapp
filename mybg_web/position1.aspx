<%@ Page Language="C#" AutoEventWireup="true" CodeFile="position1.aspx.cs" Inherits="position1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="Sort-eject Sort-height">
            <ul class="Sort-Sort" id="Sort-Sort">
                <li>
                    <a href="position.aspx?exp=不限">不限</a>
                </li>
                <li>
                    <a href="position.aspx?exp=应届毕业生">应届毕业生</a>
                </li>
                <li>
                    <a href="position.aspx?exp=1年以上">1年以上</a>
                </li>
                <li>
                    <a href="position.aspx?exp=2年以上">2年以上</a>
                </li>
                <li>
                    <a href="position.aspx?exp=3年以上">3年以上</a>
                </li>
                <li>
                    <a href="position.aspx?exp=5年以上">5年以上</a>
                </li>
                <li>
                    <a href="position.aspx?exp=8年以上">8年以上</a>
                </li>
                <li>
                    <a href="position.aspx?exp=10年以上">10年以上</a>
                </li>
            </ul>
        </div>
        <!-- End Sort -->
                ...
                $.ready(function () {
                    ...
                    showCityPickerButton.addEventListener('tap', function (event) {
                        cityPicker3.show(function (items) {
                            location.href = "position.html?pro=" + _getParam(items[0], 'value') + "&city=" + _getParam(items[1], 'value') + "&three=" + _getParam(items[2], 'value');
                        });
                    }, false);
                    // 选择职能
                    ...
                    showJobPickerButton.addEventListener('tap', function (event) {
                        JobPicker.show(function (items) {
                            location.href = "position.html?job=" + _getParam(items[0], 'value') + "&son=" + _getParam(items[1], 'value') + "&post=" + _getParam(items[2], 'value');
                        });
                    }, false);
                });
            })(mui, document);
