<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_part.aspx.cs" Inherits="c_part" %>
				...
				<div class="mui-row">
					<div class="mui-col-sm-6 mui-col-xs-6">
						<li class="mui-table-view-cell">
							<a href="c_part.aspx" class="active">
								兼职
							</a>
						</li>
					</div>
...
<div class="Sorttype-eject Sorttype-height">
    <ul class="Sorttype-Sorttype" id="Sorttype-Sorttype">
        <li>
            <a href="c_part.aspx?type=传单派发">传单派发</a>
        </li>
        <li>
            <a href="c_part.aspx?type=促销导购">促销导购</a>
        </li>
        <li>
            <a href="c_part.aspx?type=话务客服">话务客服</a>
        </li>
        <li>
            <a href="c_part.aspx?type=礼仪模特">礼仪模特</a>
        </li>
        <li>
            <a href="c_part.aspx?type=老师家教">老师家教</a>
        </li>
        <li>
            <a href="c_part.aspx?type=服务员">服务员</a>
        </li>
        <li>
            <a href="c_part.aspx?type=问卷调查">问卷调查</a>
        </li>
        <li>
            <a href="c_part.aspx?type=审核录入">审核录入</a>
        </li>
        <li>
            <a href="c_part.aspx?type=地推拉访">地推拉访</a>
        </li>
        <li>
            <a href="c_part.aspx?type=其他">其他</a>
        </li>
    </ul>
</div>
<!-- End Sorttype -->
...
<div class="Sortcycle-eject Sortcycle-height">
    <ul class="Sortcycle-Sortcycle" id="Sortcycle-Sortcycle">
        <li>
            <a href="c_part.aspx?cycle=日结">日结</a>
        </li>
        <li>
            <a href="c_part.aspx?cycle=周结">周结</a>
        </li>
        <li>
            <a href="c_part.aspx?cycle=月结">月结</a>
        </li>
        <li>
            <a href="c_part.aspx?cycle=完工结">完工结</a>
        </li>
    </ul>
</div>
<!-- End Sortcycle -->
             ...
             $.ready(function () {
                 ...
                 showCityPickerButton.addEventListener('tap', function (event) {
                     cityPicker3.show(function (items) {
                         location.href = "c_part.aspx?pro=" + _getParam(items[0], 'value') + "&city=" + _getParam(items[1], 'value') + "&three=" + _getParam(items[2], 'value');
                     });
                 }, false);
                 // 选择职能
                 ...
                 showJobPickerButton.addEventListener('tap', function (event) {
                     JobPicker.show(function (items) {
                         location.href = "c_part.aspx?job=" + _getParam(items[0], 'value') + "&son=" + _getParam(items[1], 'value') + "&post=" + _getParam(items[2], 'value');
                     });
                 }, false);
             });
         })(mui, document);
