...
public partial class resumea : System.Web.UI.Page
{
    ...
    public static string Wexperienceb, educationb, functionb, projectb, trainb, Integrity,Src;
    ...
    protected void Date()
    {
        DataTable dt = DAL.SQLHelper.GetDtBySql("select * from m_info where username='" + Session["userName"].ToString() + "'");
        if (dt.Rows.Count > 0)
        {
            ...
            evaluateA = "c_evaluate.aspx?Id=" + dt.Rows[0]["Id"].ToString();
