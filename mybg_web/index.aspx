...
<body class="mui-ios mui-ios-11 mui-ios-11-0">
        ...
        <div class="index_search_cont">
            <form method="get" action="position.aspx">
                ...
                <div class="index_formFiled index_formFiled_text">
                    <input type="text" value="" name="keyword" class="index_input_search"
                        placeholder="请输入职位关键字，如：会计... " />
    ...
    <section>
        <div class="wap_tit">
            <div class="bg3">
                <div class="wap_tit4"><span class="wap_tit4_bg"><i class="wap_tit4_icon_zw"></i>
                        <font color="#2383f0">最新兼职</font>
                    </span>
                    <a href="c_part.aspx" class="wap_titmore">更多>></a></div>
            </div>
        </div>
        ...
        <div class="wap_tit">
            <div class="bg3">
                <div class="wap_tit4"><span class="wap_tit4_bg"><i class="wap_tit4_icon_zw"></i><font color="#2383f0">最新职位</font></span>
                    <a href="position.aspx" class="wap_titmore">更多>></a></div>
            </div>
        </div>
        <div class="index_warp_jobcontent">
            <%=newest%>
    ...
    <section>
        ...
        <div class="wap_tit">
            <div class="bg3">
                <div class="wap_tit4"><span class="wap_tit4_bg"><i class="wap_tit4_icon_mq"></i>
                        <font color="#ff9c00">名企招聘</font>
                    </span><a href="c_company.aspx" class="wap_titmore">更多>></a></div>
            </div>
        </div>
    ...
    <section>
        <div class="wap_tit">
            <div class="bg3">
                <div class="wap_tit4"><span class="wap_tit4_bg"><i class="wap_tit4_icon_tj"></i>
                        <font color="#42a30d">推荐职位</font>
                    </span><a href="position.aspx?Recommend=1" class="wap_titmore">更多>></a></div>
            </div>
        </div>
    ...
    <section>
        <div class="wap_tit">
            <div class="bg3">
                <div class="wap_tit4"><span class="wap_tit4_bg"><i class="wap_tit4_icon_user"></i>
                        <font color="#0090ff">最新简历</font>
                    </span><a href="m_resume.aspx" class="wap_titmore">更多>></a></div>
            </div>
        </div>
    ...
    <div class="wap_tit">
        <div class="bg3">
            <div class="wap_tit4"><span class="wap_tit4_bg"><i class="wap_tit4_icon_news"></i>
                    <font color="#d5870d">职场资讯</font>
                </span>
                <!-- <a href="#" class="wap_titmore">更多>></a> -->
            </div>
        </div>
    </div>
    <!-- ------------------------------------最新---------------------------->
