...
public partial class pages_qy_info2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string Moneytype = moneytype.Value;
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["Id"]))
        {
            ...
            sql += " linkmail=" + Linkmail + ",preview=" + Preview + ",website=" + Website + ",linkjob=" + Linkjob + ",linkqq=" + Linkqq + ",busstops=" + Busstops + ",sdate=" + Sdate + ",money=" + Money + ",time='" + time + "',cityid='" + Cityid + "',three_cityid='" + Three_cityid + "' where G_Id=" + Request.QueryString["Id"] + " ";
        ...
        else
        {
            ...
            string sql = "insert into qy_info (Id,username,name,hy,pr,mun,provinceid,address,linkman,linktel,linkphone,content,welfareshow,linkmail,preview,website,linkjob,linkqq,busstops,sdate,money,time,recommend,cityid,three_cityid,qualifications) values ";
            sql += " ('" + A + "','" + Session["userName"] + "','" + Name + "','" + Hy + "','" + Pr + "','" + Mun + "','" + Provinceid + "','" + Address + "','" + Linkman + "','" + Linktel + "','" + Linkphone + "','" + Content + "','" + Welfareshow + "','" + Linkmail + "','" + Preview + "','" + Website + "','" + Linkjob + "','" + Linkqq + "','" + Busstops + "','" + Sdate + "','" + Money + "','" + time + "','0','" + Cityid + "','" + Three_cityid + "','0')";
            DAL.SQLHelper.GetExecute(sql);
        }
