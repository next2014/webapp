<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_special.aspx.cs" Inherits="pages_qy_special" %>
...
<body class="mui-ios mui-ios-11 mui-ios-11-0" spellcheck="false">
    ...
    <div class="header_bg bg3">
        ...
        <div class="header_h1">专职招聘</div>
    </div>
</header>
<section class="wap_member">
    <div class="wap_member_comp_h1" style="position:relative"><span>专职招聘</span></div>
    <div class="wap_member_job_show">
        <div class="wap_member_no">亲爱的用户，目前您还没有参加的专题招聘</div>
        <em class="wap_memberjob_fabu ">
            <a href="qy_zph.html" style="width:100%;height:43px; line-height:43px; font-size:16px; margin-top:10px; background:#F90;color:#fff; display:inline-block; text-align:center">查看招聘会信息</a>
        </em>
    </div>
</section>
