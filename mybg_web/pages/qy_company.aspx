<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_company.aspx.cs" Inherits="qy_company" %>
...
<body class="mui-ios mui-ios-11 mui-ios-11-0">
    ...
    <div class="Sorthy-eject Sorthy-height">
        <ul class="Sorthy-Sorthy" id="Sorthy-Sorthy">
            <li>
                <a href="qy_company.aspx?hy=互联网/电子商务">互联网/电子商务</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=IT服务（系统/数据/维护）">IT服务（系统/数据/维护）</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=互联网/电子商务">计算机软件/硬件</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=交通/运输/物流">交通/运输/物流</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=航空/航天研究与制造">航空/航天研究与制造</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=医疗设备/器械">医疗设备/器械</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=医药/生物工程">医药/生物工程</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=办公用品及设备">办公用品及设备</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=印刷/包装/造纸">印刷/包装/造纸</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=仪器仪表及工业自动化">仪器仪表及工业自动化</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=加工制造（原料加工/模具）">加工制造（原料加工/模具）</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=大型设备/机电设备/重工业">大型设备/机电设备/重工业</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=医疗/护理/美容/保健">医疗/护理/美容/保健</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=酒店/餐饮">酒店/餐饮</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=旅游/度假">旅游/度假</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=农/林/牧/渔">农/林/牧/渔</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=学术/科研">学术/科研</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=政府/公共事业/非盈利机构">政府/公共事业/非盈利机构</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=环保">环保</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=电气/电力/水利">电气/电力/水利</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=石油/石化/化工">石油/石化/化工</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=能源/矿产/采掘/冶炼">能源/矿产/采掘/冶炼</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=娱乐/体育/休闲">娱乐/体育/休闲</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=媒体/出版/影视/文化传播">媒体/出版/影视/文化传播</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=汽车/摩托车">汽车/摩托车</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=工艺美术/收藏品/奢侈品">工艺美术/收藏品/奢侈品</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=网络游戏">网络游戏</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=通信/电信/网络设备">通信/电信/网络设备</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=通信/电信运营、增值服务">通信/电信运营、增值服务</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=电子技术/半导体/集成电路">电子技术/半导体/集成电路</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=基金/证券/期货/投资">基金/证券/期货/投资</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=金融/保险/银行">金融/保险/银行</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=信托/担保/拍卖/典当">信托/担保/拍卖/典当</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=房地产/建筑/建材/工程">房地产/建筑/建材/工程</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=家居/室内设计/装饰装潢">家居/室内设计/装饰装潢</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=物业管理/商业中心">物业管理/商业中心</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=专业服务/咨询(财会/法律/人力资源等)">专业服务/咨询(财会/法律/人力资源等)</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=广告/会展/公关">广告/会展/公关</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=教育/培训">教育/培训</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=租赁服务">租赁服务</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=零售/批发">零售/批发</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=贸易/进出口">贸易/进出口</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=耐用消费品（服饰/纺织/皮革/家具/家电）">耐用消费品（服饰/纺织/皮革/家具/家电）</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=快速消费品（食品/饮料/烟酒/日化）">快速消费品（食品/饮料/烟酒/日化）</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=外包服务">外包服务</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=检验/检测/认证">检验/检测/认证</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=中介服务">中介服务</a>
            </li>
            <li>
                <a href="qy_company.aspx?hy=其他">其他</a>
            </li>
        </ul>
    </div>
    <!-- End Sorthy -->
    ...
    <div class="Sortpr-eject Sortpr-height">
        <ul class="Sortpr-Sortpr" id="Sortpr-Sortpr">
            <li>
                <a href="qy_company.aspx?pr=外资企业">外资企业</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=合资企业">合资企业</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=民营企业">民营企业</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=股份制企业">股份制企业</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=集体企业">集体企业</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=上市公司">上市公司</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=国家机关">国家机关</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=事业单位">事业单位</a>
            </li>
            <li>
                <a href="qy_company.aspx?pr=其他">其他</a>
            </li>
        </ul>
    </div>
    <!-- End Sortpr -->
    ...
    <div class="Sortmun-eject Sortmun-height">
        <ul class="Sortmun-Sortmun" id="Sortmun-Sortmun">
            <li>
                <a href="qy_company.aspx?mun=10人以下">10人以下</a>
            </li>
            <li>
                <a href="qy_company.aspx?mun=10-50人">10-50人</a>
            </li>
            <li>
                <a href="qy_company.aspx?mun=50-200人">50-200人</a>
            </li>
            <li>
                <a href="qy_company.aspx?mun=200-500人">200-500人</a>
            </li>
            <li>
                <a href="qy_company.aspx?mun=500-1000人">500-1000人</a>
            </li>
            <li>
                <a href="qy_company.aspx?mun=1000人以上">1000人以上</a>
            </li>
        </ul>
    </div>
    <!-- End Sortmun -->
            ...
            $.ready(function () {
                ...
                showCityPickerButton.addEventListener('tap', function (event) {
                    cityPicker3.show(function (items) {
                        location.href = "qy_company.aspx?pro=" + _getParam(items[0], 'value') + "&city=" + _getParam(items[1], 'value') + "&three=" + _getParam(items[2], 'value');
                    });
                }, false);
                // 选择职能
