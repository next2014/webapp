<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_resume.aspx.cs" Inherits="pages_qy_resume" %>
            ...
            $.ready(function () {
                ...
                showCityPickerButton.addEventListener('tap', function (event) {
                    cityPicker3.show(function (items) {
                        location.href = "qy_resume.aspx?city=" + _getParam(items[1], 'value') ;
                    });
                }, false);
                // 选择职能
                ...
                showJobPickerButton.addEventListener('tap', function (event) {
                    JobPicker.show(function (items) {
                        location.href = "qy_resume.aspx?post=" + _getParam(items[2], 'value');
                    });
                }, false);
            });
        })(mui, document);
