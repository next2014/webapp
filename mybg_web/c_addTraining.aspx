<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_addTraining.aspx.cs" Inherits="c_addTraining" %>
                                        ...
                                        <div class="resume-cont">
                                            <div class="">
                                                <ul class="yunset_list mt15">
                                                    <li class="yunset_list_text"><span class="yunset_list_name">培训中心</span> <span class="yunset_list_commentary">
                                                        <input type="text" runat="server" name="name" id="name" value="" placeholder="请输入培训中心" /></span></li>
                                                    <li class="yunset_list_text"><span class="yunset_list_name">培训方向</span> <span class="yunset_list_commentary">
                                                        <input type="text" runat="server" name="titlea" id="titlea" value="" placeholder="请输入培训方向" /></span></li>
                                                </ul>
                                                <ul class="yunset_list mt15">
                                                ...
                                                <ul class="yunset_list mt15">
													<li class="yunset_list_text">
															<span class="yunset_list_name" style="height150px;">培训描述</span>
                                                       <br /><br />
													</li>
												</ul>
                                                <div class="" >
                                                    <div class="yun_wap_addresume_box_group">
                                                        <div class="yun_wap_addresume_box_control_text">
                                                            <textarea name="content" runat="server" id="content" style="height: 200px;" class="yun_wap_addresume_texttextAreaMsg" placeholder="请填写培训描述" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>
