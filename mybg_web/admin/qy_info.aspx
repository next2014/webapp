<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qy_info.aspx.cs" Inherits="admin_qy_info" %>
                ...
                <div class="d_Confirm_Order_style">
                    <div class="search_style">
                        ...
                        <ul class="search_content clearfix">
                            <li>
                                <label class="l_f">关键字</label><input runat="server" id="txtKeywords" name="txtKeywords" type="text" class="text_add" placeholder="输入企业名称" style="width: 400px" /></li>
                             <li><label class="l_f">添加时间</label><input runat="server" class="inline laydate-icon" id="start" style="margin-left: 10px;"  /></li>
                            <li><asp:DropDownList ID="drop1" runat="server"><asp:ListItem></asp:ListItem><asp:ListItem>待认证</asp:ListItem><asp:ListItem>已认证</asp:ListItem><asp:ListItem>未认证</asp:ListItem></asp:DropDownList></li>
                            <li style="width: 90px;">
                    ...
                    <div class="border clearfix">
                        <span class="l_f">
                            <a href="#" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加名企</a>
                        ...
                        <asp:Repeater ID="rptList" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="qy_info_add.aspx?id=<%#Eval("Id") %>" style="cursor: pointer" class="text-primary"><%#Eval("name")%></a>
                                    </td>
                                    <td><%#Eval("hy")%></td>
                                    <td><%#Eval("mun")%></td>
                                    <td><%#Eval("pr")%></td>
                                    <td><%#Eval("address")%></td>
                                    <td><%#Convert.ToInt32(Eval("qualifications"))==1 ? "已认证" : (Convert.ToInt32(Eval("qualifications"))==2 ? "待认证":"未认证") %></td>
                                    <td><%#Eval("time")%></td>
                                    <td class="td-manage">
                                        <a title="推荐" href="qy_info.aspx?Id=<%#Eval("Id") %>&rec=<%#Eval("recommend") %>"  class="<%#Convert.ToInt32(Eval("recommend"))==1 ? "btn btn-xs btn-success" : "btn btn-xs" %>"><i class="icon-ok bigger-120"></i></a> 
                                          <a title="企业详细" href="qy_info_add.aspx?Id=<%#Eval("Id") %>" class="btn btn-xs btn-info Refund_detailed">详细</a>
                                     <%--   <a title="编辑" href="qy_info_add.aspx?id=<%#Eval("Id") %>" class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>--%>
                                        <a title="删除"  href="qy_info.aspx?del=<%#Eval("Id") %>"  onclick="return confirm('确定删除?');" class="btn btn-xs btn-warning"><i class="icon-trash  bigger-120"></i></a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
