<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_addProject.aspx.cs" Inherits="c_addProject" %>
...
<head runat="server">
    ...
    <script src="s/jquery-1.8.0.min.js" language="javascript"></script>
                                            ...
                                            <div class="">
                                                ...
                                                <ul class="yunset_list mt15">
                                                    <li><span class="yunset_list_name">开始时间</span> <span class="yunset_list_commentary">
                                                        <button id="sdatePicker" runat="server" data-options="{&quot;type&quot;:&quot;month&quot;,&quot;beginYear&quot;:1955,&quot;endYear&quot;:2099}" class="btn mui-btn mui-btn-block" type="button">请选择开始时间</button>
                                                    ...
                                                    <li><span class="yunset_list_name">结束时间</span> <span class="yunset_list_commentary">
                                                        <button id="edatePicker" runat="server" data-options="{&quot;type&quot;:&quot;month&quot;,&quot;beginYear&quot;:1955,&quot;endYear&quot;:2099}" class="btn mui-btn mui-btn-block" type="button">请选择结束时间</button>
                                                        <input type="hidden" runat="server" id="edate" name="edate" value="" /></span>
                                                    </li>
                                                </ul>
                                                <ul class="yunset_list mt15">
													<li class="yunset_list_text">
															<span class="yunset_list_name" style="height150px;">项目内容</span>
                                                       <br /><br />
													</li>
												</ul>
                                                <div class="" >
                                                    <div class="yun_wap_addresume_box_group">
                                                        <div class="yun_wap_addresume_box_control_text">
                                                            <textarea name="content" runat="server" id="content" style="height: 200px;" class="yun_wap_addresume_texttextAreaMsg" placeholder="请填写项目内容" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>
