<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_edu.aspx.cs" Inherits="c_edu" %>
    ...
    <div class="body_wap">
        ...
        <div class="resume-cont">
            ...
            <div class="add_resume_tjbth">
                <a class="add_resume_tj" href="<%=UeducationA%>">+ 添加教育经历</a>
