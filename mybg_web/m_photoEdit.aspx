<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_photoEdit.aspx.cs" Inherits="m_photoEdit" %>
            ...
            <div class="photo_i_box_v">
                <div class="photo_i_box_v_c">
                    <div id="showResult">
                        ...
                        <div class="clear"></div>
                        <div class="photo_xz">
                            <input id="file" name="file" type="file" accept="image/*" onchange="imgChange(this);">选择上传头像
                        </div>
