<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c_addresumeson.aspx.cs" Inherits="c_addresumeson" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function User() {
            ...
            if (div.className == "mui-switch mui-switch-mini totoday mui-active") {
                document.getElementById('a').className = 'mui-switch mui-switch-mini totoday';
                document.getElementById('b').style.transform = 'translate(0px, 0px)'
                document.getElementById('totoday').value = ''

            }
            else {
                document.getElementById('a').className = 'mui-switch mui-switch-mini totoday mui-active';
    ...
    <script type="text/javascript">
        function UserAddVerify() {
            ...
            else if ((Edate == "" || Edate == null) && (Totoday == "" || Totoday == null)) {
                alert("请选择离职时间");
                return false;
            }
                                        ...
                                        <div class="resume-cont">
                                            <div class="">
                                                <ul class="yunset_list mt15">
                                                    <li class="yunset_list_text"><span class="yunset_list_name">单位名称</span> <span class="yunset_list_commentary">
                                                        <input type="text" runat="server" name="name" id="name" value="" placeholder="请输入单位名称" /></span></li>
                                                    <li class="yunset_list_text"><span class="yunset_list_name">担任职位</span> <span class="yunset_list_commentary">
                                                        <input type="text" runat="server" name="titlea" id="titlea" value="" placeholder="请输入担任职位" /></span></li>
                                                </ul>
                                                <ul class="yunset_list mt15">
                                                    <li><span class="yunset_list_name">入职时间</span> <span class="yunset_list_commentary">
                                                        <button id="sdatePicker" runat="server" data-options="{&quot;type&quot;:&quot;month&quot;,&quot;beginYear&quot;:1955,&quot;endYear&quot;:2099}" class="btn mui-btn mui-btn-block" type="button">请选择入职时间</button>
                                                    ...
                                                    <li><span class="yunset_list_name">离职时间</span> <span class="yunset_list_commentary">
                                                        <button id="edatePicker" runat="server" data-options="{&quot;type&quot;:&quot;month&quot;,&quot;beginYear&quot;:1955,&quot;endYear&quot;:2099}" class="btn mui-btn mui-btn-block" type="button">请选择离职时间</button>
                                                        <input type="hidden" runat="server" id="edate" name="edate" value="" /></span>
                                                    </li>
                                                    <li class="yunset_list_text">
                                                        <span class="yunset_list_name" style="width: 150px;">至今<em class="yunset_xttip"></em></span>
                                                        <div class="yunset_kg_box" onclick="User()">
                                                            <div class="yunset_kg">
                                                                <div id="a" class="mui-switch mui-switch-mini totoday <%=yunset%>" data-switch="4" style="transition-duration: 0.2s;"><div id="b" class="mui-switch-handle" style="transition-duration: 0.2s; transform: translate(<%=yunseta%>px, 0px);"></div></div>
                                                ...
                                                <ul class="yunset_list mt15">
													<li class="yunset_list_text">
															<span class="yunset_list_name" style="height:150px">工作描述</span>
                                                       <br /><br />
													</li>
												</ul>
                                                    <div class="yun_wap_addresume_box_group">
                                                        <div class="yun_wap_addresume_box_control_text">
                                                            <textarea name="content" runat="server" id="content" style="height: 200px;" class="yun_wap_addresume_texttextAreaMsg" placeholder="请输入工作描述" ></textarea>
                                                        </div>
                                                    </div>
