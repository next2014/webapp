<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_collecRecord.aspx.cs" Inherits="m_collecRecord" %>
...
<div class="body_wap">
    ...
    <div class="main_member_cot_box">
        <ul class="yun_m_tit">
            <li class="yun_m_tit_cur"><a href="m_collecRecord.aspx">收藏的职位</a></li>
            <li><a href="m_collecRecord1.aspx">关注的企业</a></li>
        </ul>
        <%=record%>

    </div>
    <div class="wap_member_no" style="<%=display%>">
        <div class="wap_member_no_p1">
	        <div>没有收藏过职位</div>
	        <div><a class="wap_member_no_search" href="c_part.aspx">搜索职位</a></div>
	    </div>
    </div>
    <div class="pages"></div>
</div>
