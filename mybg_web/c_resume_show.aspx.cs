...
public partial class c_resume_show : System.Web.UI.Page
{
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["Id"]))
        {
            ...
            if (Session["userName"] != null)
            {
                ...
                if (dt10.Rows.Count > 0)
                {
                    ...
                    {
                        RCollection = "<a href=\"c_resume_show.aspx?Id=" + dt.Rows[0]["Id"].ToString() + "&Collection=2\"><i class=\"iconfont_ysc\"></i><span class=\"yun_job_footer_s yun_job_footer_s_y\">已收藏</span></a>";
                    }
                    else
                    {
                        RCollection = "<a href=\"c_resume_show.aspx?Id=" + dt.Rows[0]["Id"].ToString() + "&Collection=1\"><i class=\"iconfont_sc\"></i><span class=\"yun_job_footer_s\">收藏</span></a>";
                    }
                }
                else
                {
                    RCollection = "<a href=\"c_resume_show.aspx?Id=" + dt.Rows[0]["Id"].ToString() + "&Collection=0\"><i class=\"iconfont_sc\"></i><span class=\"yun_job_footer_s\">收藏</span></a>";
                }
            }
            else
            {
	   ...
	   if (Session["userName"].ToString() == "" || Session["userName"] == null) 
            {
             ...
             if (dt.Rows[0][0].ToString() == "2")
             {
                 if (Button1.Text == "面试邀请") 
                 {
                     ...
                     if (A > 0)
                     {
                         Response.Redirect("pages/qy_invite1.aspx?JLId=" + Request.QueryString["Id"]);
                     }
                     else 
                     {
