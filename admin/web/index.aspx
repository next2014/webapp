...
<script type="text/javascript">
    try { ace.settings.check('sidebar', 'fixed') } catch (e) { }
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 仓库管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="cangku/list.aspx"  title="商品列表" class="iframeurl"><i class="icon-double-angle-right"></i>商品列表</a></li>
						 <li class="home"><a  href="javascript:void(0)" name="cangku/add.aspx" title="添加商品"  class="iframeurl"><i class="icon-double-angle-right"></i>添加商品</a></li>
						</ul>
					</li>
					<li>
				  ...
				  <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 店铺管理 </span><b class="arrow icon-angle-down"></b></a>
						...
						<li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 流程管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="cangku/list.aspx" title="流程列表" class="iframeurl"><i class="icon-double-angle-right"></i>流程列表</a></li>
                                <li class="home"><a href="javascript:void(0)" name="cangku/add.aspx" title="申请流程" class="iframeurl"><i class="icon-double-angle-right"></i>申请流程</a></li>
							</ul>
						</li>                        
