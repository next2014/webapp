<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="cangku_add" %>
 ...
 <div class="article_style">
    <div class="add_content" id="form-article-add">
     <ul>
      ...
      <span class="formControls col-10"><input name="文章简介" type="text" id="Text1" class="col-xs-10 col-sm-6 "></span>
      </li>
      <li class="clearfix"><label class="label_name">排序</label><span class="formControls col-10"><input type="text" id="Text2" class="col-xs-10 col-sm-1"></span></li>
